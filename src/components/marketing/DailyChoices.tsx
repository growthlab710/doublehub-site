...
const choices: Choice[] = [
  {
    ...
    double:
      'TrainNoteの記録見ると、今週は強度高めで疲労溜まってる。読書は進みが良いから、今日は軽めの運動で切り替えて、明日の朝に学習を入れるのがいい感じ。',
  ...
  },
  {
    ...
    why: 'TrainNote の記録から「中断→復帰」のパターンを知っているから、タイミングと強度を適切に提案できる。',
  },
  {
    tag: 'BookCompass 連携',
  ...
  },
  {
    ...
    double:
      'TrainNoteの運動頻度が3週間で半分に落ちてる。BookCompassも2週間新しい本を開いてない。前にこのパターンになった時は仕事の負荷が原因だったよね。今週は回復に振り切って、来週からまた始めよう。',
