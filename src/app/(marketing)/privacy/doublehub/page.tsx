  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          日記情報（ユーザーが日記機能で保存する写真、気分スタンプ、メモ。写真は端末内にのみ保存し、当方が管理するサーバーへ送信・保存しません）
        </li>
        <li>
          本アプリが生成する補助情報（AI
      ...
      <p>
        アプリの改善と継続利用の分析のため、利用状況に関する最小限のイベントデータを開発者のサーバーに送信・記録します。送信するのは、操作の種類（アプリの起動、日記の作成、週次ふり返り・未来日記の閲覧）、発生日時、アプリのバージョン情報のみです。
      </p>
      <ul>
        <li>日記の本文・写真・気分の内容など、記録の中身は一切送信しません。</li>
        <li>
