...
const albumPoints = [
  {
    title: 'ダブルが、選んで貼る',
    body:
      'あなたの日記から、ダブルが幸せの種を見つけて、月ごとのページに貼っていきます。写真と、日付・場面の題、その日の手がかり（気分、一緒にいた相手、「はじめてのこと」「またやりたい」）。旅行は数日でひとつのページに。その日にダブルが返した一言と、あなたの一行が、そのままの言葉で添えられます（章の便りは Plus）。',
  },
  {
    title: '順位をつけない、数えない',
    body:
        ...
        <Container width="wide">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-sm leading-[1.9] text-text-muted md:text-base">
              ダブルが、あなたの日記帳から思い出の写真と言葉を選んで、月ごとのページに貼り直します。「この日はこうだったね」と、一緒に見返す場所です。なぜその1枚なのかも、手がかりごと貼ってあります。
            </p>
          </div>
